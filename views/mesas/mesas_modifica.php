...
<body>
    ...
    <section class="full-width pageContent">
        <div class="container">
            ...
            <form id="nuevo" name="nuevo" method="POST" action="index3.php?c=Mesas&a=actualizar" autocomplete="off">
                <?php
                ...
                <div class="form-group">
                    ...
                    <option value="<?php echo $data["Mesas"]["idSede"]?>"><?php echo $data["Mesas"]["NombreSede"]?></option>
                        <?php
                        if ($resultado1 > 0) {
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $data["Mesas"]["nombre"]?>"/>
                </div>
                <input type="hidden" name="id_mesa" value="<?php echo $data["Mesas"]["id_mesa"]; ?>">
