...
<body>
    ...
    <section class="full-width pageContent">
        <div class="container">
            ...
            <form id="nuevo" name="nuevo" method="POST" action="index2.php?c=Inventarios&a=actualizar" autocomplete="off">
                <?php
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="sede" id="sede">
                        <option value="<?php echo $data["inventarios"]["idSede"]?>"><?php echo $data["inventarios"]["nomSede"]?></option>
                        <?php
                        if ($resultado1 > 0) {
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="proveedor" id="proveedor">
                        <option value="<?php echo $data["inventarios"]["idProveedor"]?>"><?php echo $data["inventarios"]["nomPro"]?></option>
                        <?php
                        if ($resultado1 > 0) {
                            while ($sede = mysqli_fetch_array($resultado)) {
                        ?>
                ...
                <input type="hidden" id="idProducto" name="idProducto" value="<?php echo $data["inventarios"]["id_producto"]; ?>" />        

                <div class="form-group">
                    <label for="Identificacion">Nombre Producto</label>
                    <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $data["inventarios"]["nombreP"]?>"/>
                </div>

                <div class="form-group">
                    <label for="Nombres">Precio</label>
                    <input type="text" class="form-control" id="precio" name="precio" value="<?php echo $data["inventarios"]["precio"]?>"/>
                </div>

                <div class="form-group">
                    <label for="Apellidos">Cantidad</label>
                    <input type="text" class="form-control" id="cantidad" name="cantidad" value="<?php echo $data["inventarios"]["cantidad"]?>"/>
                </div>
